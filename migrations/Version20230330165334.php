 ...
 */
final class Version20230330165334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, recipe_name VARCHAR(150) NOT NULL, ingredients LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', preparation_time VARCHAR(20) DEFAULT NULL, cuisine_type VARCHAR(40) DEFAULT NULL, meal_type VARCHAR(40) DEFAULT NULL, description VARCHAR(1500) NOT NULL, instructions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
