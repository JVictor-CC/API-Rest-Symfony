 ...
 */
final class Version20230326165507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, credentials_id INT NOT NULL, username VARCHAR(60) NOT NULL, email VARCHAR(255) NOT NULL, saved_recipes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', created_recipes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D64941E8B2E5 (credentials_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
